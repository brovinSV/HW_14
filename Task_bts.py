"""
1.Додайте до класу Tree метод, який реалізує додавання до бінарного
дерева пошуку нових елементів зі списку. Метод має містити
функціонал, який перевіряє дані із списку на відповідність до правил
формування бінарного дерева пошуку.
2. Додайте до класу Tree методи пошуку мінімального і максимального
значення елементів в бінарному дереві пошуку.
3. Розширте функціонал класу Tree, додавши в нього метод видалення
елементів в бінарному дереві пошуку.
"""
class Tree:
